...
DISCORD_TOKEN = "MTQzNjg0NzgyNzU3NjY4ODg0MQ.GdZAdP.tyHznCkmcWD5QKjjQk6mWtT-cRQuWrvjpuQHSM"
...
FILTER_BY_NAME = False, ["Graipuss Medussi", "La Grande Combinasion","La Secret Combinasion"] # filter by name, фильтр по имени
...
READ_CHANNELS = ['giq_1m-10m', "giq_10m"] # channels / каналы
...
CHILLI_HUB_CHANNELS_ID = {
    ...
    "giq_1m-10m": ["1378601518059622444", "1401775125765947442"], # 1m - 10m channels

    "giq_10m": ["1378601518059622440"], # 10m+ channels



    "giq_1-10m": ["1378601518059622444"], # 1m - 10m notasnek discord channel

    "giq_10m": ["1378601518059622440"] # 10m+ notasnek discord channel
...
# https://github.com/slarequirepo/roblox-autojoiner
